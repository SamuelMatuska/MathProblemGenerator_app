            ...
            <tbody>
                <?php foreach ($users as $user) : 
                    if ($user['studentID'] == 187) {
                        continue;}?>
                    <tr class="text-center">
                        <td><a href="selectedstudent.php?id=<?php echo $user['id']; ?>" style="color:black; text-decoration:none"><?php echo $user['first_name']; ?></a></td>
                        <td><a href="selectedstudent.php?id=<?php echo $user['id']; ?>" style="color:black; text-decoration:none"><?php echo $user['last_name']; ?></a></td>
                        <td><a href="selectedstudent.php?id=<?php echo $user['id']; ?>" style="color:black; text-decoration:none"><?php echo $user['username']; ?></a></td>
                        <td><a href="selectedstudent.php?id=<?php echo $user['id']; ?>" style="color:black; text-decoration:none"><?php echo $user['studentID']; ?></a></td>
                        <td><a href="selectedstudent.php?id=<?php echo $user['id']; ?>" style="color:black; text-decoration:none"><?php echo $user['right_answer']; ?></a></td>
                        <td><a href="selectedstudent.php?id=<?php echo $user['id']; ?>" style="color:black; text-decoration:none"><?php echo $user['answered']; ?></a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
